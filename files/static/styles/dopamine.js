window.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll("img").forEach((img) => {
        if (
            img.src.includes("/static/images/icons/favicon.png") ||
            img.src.includes("/static/images/icons/hires/favicon.png")
        ) {
            img.remove();
        }
    });
                        ...
                        if (item.ext === "folder") {
                            ...
                            li.addEventListener("click", function (e) {
                                ...
                                if (li.classList.contains("open")) {
                                    ...
                                    li.querySelectorAll("ul").forEach((child) =>
                                        child.remove(),
                                    );
                                } else {
                            ...
                            ["png", "jpeg", "jpg", "svg"].includes(item.ext)
                        ) {
                            li.className = "img";
                            li.addEventListener("click", function (e) {
                                e.stopPropagation();
                            ...
                            ["php", "webp", "java", "jar"].includes(item.ext)
                        ) {
                            li.className = "shp";
                            li.addEventListener("click", function (e) {
                                e.stopPropagation();
